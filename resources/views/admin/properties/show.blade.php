            ...
            <div class="card">
                ...
                <div class="header">
                    <h2>
                        {{$property->title}}
                        <br>
                        <small>Posted By <strong>VEE Estates</strong> on {{$property->created_at->toFormattedDateString()}}</small>
                    </h2>
                </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <img class="img-responsive thumbnail" src="{{ $property->image }}" alt="{{$property->title}}">
